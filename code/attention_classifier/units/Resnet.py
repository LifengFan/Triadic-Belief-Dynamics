...
class ResNet50(torch.nn.Module):
    ...
    def __init__(self, num_classes=512):
        ...
        pthpath = '/home/shuwen/data/Six-Minds-Project/attention_classifier/resnet50-19c8e357.pth'
        assert os.path.exists(pthpath), 'pls specify the pre-trained models'
        saved_state_dict = torch.load(pthpath)
        #Download from https://download.pytorch.org/models/resnet50-19c8e357.pth
...
class Resnet34(torch.nn.Module):
    ...
    def __init__(self, num_classes=512):
        ...
        if os.path.exists(pthpath):
            # TODO: wrong in loading pre-trained weights, only reading the weights, not loading to network
