...
def finetune_para(atomic_event_net, event_net, clip_list, para_bank, args):
...
if __name__ == "__main__":
    ...
    project_name = 'beam_search_m_lfan_05201310'  # todo: don't forget to change the project name!
    ...
    finetune_para(atomic_event_net, event_net, clip_list, para_bank, args)
