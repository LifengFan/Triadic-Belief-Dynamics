...
event_seg_tracker = {
            ...
            'test_94342_16': [[0, 21, 0], [22, 45, 0], [46, 84, 0], [85, 158, 1], [159, 200, 1],
                              [201, 214, 0],[215, 370, 1], [371, 524, 1], [525, 587, 3], [588, 782, 2],[783, 1009, 2]],
            ...
            'test_boelter_21': [[0, 238, 1], [239, 310, 0], [311, 373, 1], [374, 457, 0],[458, 546, 3], [547, 575, 1], [576, 748, 2], [749, 952, 2]],}
...
event_seg_battery={'test1': [[0, 94, 0], [95, 155, 0], [156, 225, 0], [226, 559, 0], [560, 689, 2], [690, 698, 0]],
                   ...
                   'test_boelter_21': [[0, 238, 1], [239, 285, 0], [286, 310, 0], [311, 373, 1], [374, 457, 0],
                                       [458, 546, 3], [547, 575, 1], [576, 748, 2], [749, 952, 2]],
                   ...
                   'test_94342_16': [[0, 84, 0], [85, 158, 1], [159, 200, 1], [201, 214, 0], [215, 370, 1],
                                     [371, 524, 1], [525, 587, 3], [588, 782, 2], [783, 1009, 2]],
...
clips_with_gt_event=['test_boelter2_15.p', 'test_94342_16.p', 'test_boelter4_4.p', 'test_94342_21.p', 'test_boelter4_1.p', 'test_boelter4_9.p', 'test_94342_1.p', 'test_boelter3_4.p', 'test_boelter2_2.p', 'test_boelter_2.p', 'test_boelter_21.p', 'test_boelter4_12.p', 'test_boelter_7.p', 'test_boelter2_5.p', 'test7.p', 'test_boelter_24.p', 'test_9434_18.p', 'test_94342_10.p', 'test_boelter3_13.p', 'test_boelter2_4.p', 'test_94342_6.p', 'test1.p', 'test_boelter_12.p', 'test_boelter3_0.p', 'test6.p', 'test_9434_1.p', 'test_boelter2_12.p', 'test_boelter3_6.p', 'test_boelter4_3.p', 'test_boelter3_11.p']
...
#     path=op.join('/home/lfan/Dropbox/Projects/NIPS20/annotations/', clip.split('.')[0])
#     #os.system('cp -r '+path+ ' /media/lfan/HDD/NIPS20/img/')
#     #os.system('scp -r ' + path + ' lifeng@azure.yzhu.io:/home/lifeng/img/')
#     #print 'scp -r ' + path + ' lifeng@thor:/home/lifeng/img/'
#     os.system(' rm -r /media/lfan/HDD/NIPS20/img/'+clip.split('.')[0]+'/battery')
#     os.system(' rm -r /media/lfan/HDD/NIPS20/img/' + clip.split('.')[0] + '/tracker')
#
# clips_length={}
# for clip in clips_all:
#     clips_length[clip] = len(glob.glob('/home/lfan/Dropbox/Projects/NIPS20/annotations/'+clip.split('.')[0]+'/kinect/'+'*.jpg'))
# print(clips_length)
...
print(clips_len['test_94342_21.p'])
