...
#     np.save(os.path.join(args.data_root,'attmat','attmat_test_seq.npy'), test_seq)
     ...
     train_seq=np.load(op.join(args.data_root,'attmat','attmat_train_seq.npy'), encoding='latin1')
     val_seq=np.load(op.join(args.data_root,'attmat','attmat_val_seq.npy'), encoding='latin1')
     test_seq=np.load(op.join(args.data_root,'attmat','attmat_test_seq.npy'), encoding='latin1')
