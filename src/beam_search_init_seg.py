...
def parse_arguments():
    ...
    parser.add_argument('--save-event-score', default='/media/lfan/HDD/NIPS20/data/event_score_all_0906/') #todo
...
if __name__ == "__main__":
    ...
    args.save_path=op.join(args.project_path2, 'BestTree_init_seg_0915')
    ...
    # {'topN': 8, 'lambda_1': 0.5, 'lambda_2': 0.5, 'lambda_3': 1, 'lambda_5': 1, 'lambda_6': 1, 'lambda_7': 0.5,
    #  'lambda_8': 1, 'search_N_cp': 6}
    ...
    Parallel(n_jobs=-1)(delayed(test_best_Tree)(None, None, clip_idx, clip, args) for clip_idx, clip in enumerate(clips_))
