...
class EventScore(object):
    ...
    def __init__(self, clip, atomic_net, event_net, args):
...
def parse_arguments():
    ...
    parser.add_argument('--save-root', default='/media/lfan/HDD/NIPS20/Result/event_score_per5frame/')
    parser.add_argument('--save-path', default='/media/lfan/HDD/NIPS20/Result/event_score_per5frame/')
...
if __name__ == "__main__":
    ...
    #for clip in ['test_94342_21.p']:
        print(clip)
        event_score=EventScore(clip, atomic_net, event_net, args)
        event_score()
