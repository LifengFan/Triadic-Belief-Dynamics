...
class MindCNN(torch.nn.Module):
    def __init__(self):
        super(MindCNN, self).__init__()
...
class MindLSTMHog(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1_m1 = nn.Linear(self.feature_dim, 500)
        self.fc1_m2 = nn.Linear(self.feature_dim, 20)
        self.fc1_m12 = nn.Linear(self.feature_dim, 20)
        self.fc1_m21 = nn.Linear(self.feature_dim, 20)
        self.fc1_mc = nn.Linear(self.feature_dim, 20)

        self.fc2_m1 = nn.Linear(500, 4)
        self.fc2_m2 = nn.Linear(20, 4)
        self.fc2_m12 = nn.Linear(20, 4)
        self.fc2_m21 = nn.Linear(20, 4)
        self.fc2_mc = nn.Linear(20, 4)
...
class MLP_Feature(torch.nn.Module):
    def __init__(self):
        super(MLP_Feature, self).__init__()
        self.fc_event = torch.nn.Linear(1650, 800)
        self.fc_event_2 = torch.nn.Linear(800, 400)
        self.fc_memory = torch.nn.Linear(400, 200)

        self.fc_m1_1 = torch.nn.Linear(200, 100)
        self.fc_m1_2 = torch.nn.Linear(100, 20)

        self.fc_m2_1 = torch.nn.Linear(200, 100)
        self.fc_m2_2 = torch.nn.Linear(100, 20)

        self.fc_m12_1 = torch.nn.Linear(200, 100)
        self.fc_m12_2 = torch.nn.Linear(100, 20)

        self.fc_m21_1 = torch.nn.Linear(200, 100)
        self.fc_m21_2 = torch.nn.Linear(100, 20)

        self.fc_mc_1 = torch.nn.Linear(200, 100)
        self.fc_mc_2 = torch.nn.Linear(100, 20)
    ...
    def forward(self, x):
        ...
        x2 = self.relu(self.fc_event_2(x1))
        out = self.relu(self.fc_memory(x2))

        out_mc = self.relu(self.fc_mc_1(out))
        out_mc = self.relu(self.fc_mc_2(out_mc))
        out_mc = self.fc_mc(out_mc)

        out_m1 = self.relu(self.fc_m1_1(out))
        out_m1 = self.relu(self.fc_m1_2(out_m1))
        out_m1 = self.fc_m1(out_m1)

        out_m2 = self.relu(self.fc_m2_1(out))
        out_m2 = self.relu(self.fc_m2_2(out_m2))
        out_m2 = self.fc_m2(out_m2)

        out_m12 = self.relu(self.fc_m12_1(out))
        out_m12 = self.relu(self.fc_m12_2(out_m12))
        out_m12 = self.fc_m12(out_m12)

        out_m21 = self.relu(self.fc_m21_1(out))
        out_m21 = self.relu(self.fc_m21_2(out_m21))
        out_m21 = self.fc_m21(out_m21)

        return out_m1, out_m2, out_m12,out_m21, out_mc

class MindLSTMHogCNN(torch.nn.Module):
    def __init__(self):
        super(MindLSTMHogCNN, self).__init__()
        ...
        self.fc2_m1 = nn.Linear(500, 1024)
        self.fc2_m2 = nn.Linear(20, 4)
        self.fc2_m12 = nn.Linear(20, 4)
        self.fc2_m21 = nn.Linear(20, 4)
        self.fc2_mc = nn.Linear(20, 4)
    ...
    def forward(self, obj_patch, hog_feature_input):
        ...
        fc_input = torch.cat([nodes_feature, hog_feature], 2)
