...
if __name__ == "__main__":
    ...
    args.save_path=op.join(args.project_path2, 'BestTree_unif_event_0531')
    ...
    Parallel(n_jobs=-1)(delayed(test_best_Tree)(atomic_event_net, event_net, clip_idx, clip, args) for clip_idx, clip in enumerate(clips))
