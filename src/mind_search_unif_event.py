...
def parse_arguments():
    ...
    parser.add_argument('--save-path', default=path.save_root + '/mind_posterior_unif_event_0531/')
    parser.add_argument('--mind-input-path', default=path.save_root + '/mind_likelihood_unif_event_0531/')
