...
def run():
    ...
    #args.save_path=op.join(args.project_path2, 'BestTree_full_0915_v3')
    args.save_path = op.join(args.project_path2, 'BestTree_att_obj_id_w_raw_objs_01232021')
    ...
    Parallel(n_jobs=-1)(delayed(test_best_Tree)(None, None, None, clip, args) for clip_idx, clip in enumerate(clips_))
