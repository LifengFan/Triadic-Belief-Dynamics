...
class FeatureExtractor:
    ...
    def load_file(self):
        data_path = './post_skeletons/'
        img_path = './annotations'
        depth_path = './post_images/kinect'
        save_folder = './feature_single/'
        save_pair_folder = './feature_pair/'
        battery_gaze_path = './gaze_smooth_360_battery/'
        tracker_gaze_path = './gaze_smooth_360_tracker/'
        mask_path = './pointclouds/'
        cate_path = './track_cate_with_frame/'
        bounding_box_path = './post_neighbor_smooth_newseq/'
        tracker_gt_path = './tracker_gt_smooth/'
