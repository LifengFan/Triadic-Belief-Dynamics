...
class EventScore(object):
    ...
    def run(self, clip):
        ...
        for seg in self.segs_B:
            ...
            if os.path.exists(op.join(args.save_event_score, self.clip.split('.')[0], 'battery',
                                      '{}_{}.p'.format(seg[0], seg[1]))):
                continue
...
def parse_arguments():
    ...
    parser.add_argument('--save-path', default='/media/lfan/HDD/NIPS20/Result/event_score_cps_new_0906/')
    ...
    parser.add_argument('--attmat-path', default=home_path2+'data/attention_obj_name/')
    ...
    parser.add_argument('--test-func-batch-size', default=8)
