...
def run():
    ...
    args.save_path=op.join(args.project_path2, 'BestTree_full_0915_right')
    ...
    # Parallel(n_jobs=-1)(delayed(test_best_Tree)(atomic_event_net, event_net, clip_idx, clip, args) for clip_idx, clip in enumerate(clips_))
